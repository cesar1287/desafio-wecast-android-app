...
internal class XMLParser : DefaultHandler() {
    ...
    private var enclosures: MutableList<RssEnclosure>? = null
    ...
    override fun startElement(uri: String, localName: String, qName: String,
        ...
        when (localName.toLowerCase()) {
            ...
            ENCLOSURE -> {
                ...
                enclosure.link = attributes?.getValue(0)
                enclosure.length = attributes?.getValue(1)
                enclosure.type = attributes?.getValue(2)
